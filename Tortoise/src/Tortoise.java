...
public class Tortoise {
    ...
    /**
     * Race method that will calculate time of intersection of the two "(nouns)"
     * @param v1 - speed of object 1
     * @param v2 - speed of object 2
     * @param g - distance between the objects
     * @return
     */
